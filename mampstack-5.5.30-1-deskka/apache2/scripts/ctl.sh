...
HTTPD_PIDFILE=/Applications/mampstack-5.5.30-1-deskka/apache2/logs/httpd.pid


HTTPD="/Applications/mampstack-5.5.30-1-deskka/apache2/bin/httpd -f /Applications/mampstack-5.5.30-1-deskka/apache2/conf/httpd.conf"
...
. /Applications/mampstack-5.5.30-1-deskka/apache2/bin/envvars
