...
#define DEFAULT_MYSQL_HOME "/Applications/mampstack-5.5.30-1-deskka/mysql"
#define SHAREDIR "/Applications/mampstack-5.5.30-1-deskka/mysql/share"
#define DEFAULT_BASEDIR "/Applications/mampstack-5.5.30-1-deskka/mysql"
#define MYSQL_DATADIR "/Applications/mampstack-5.5.30-1-deskka/mysql/data"
#define DEFAULT_CHARSET_HOME "/Applications/mampstack-5.5.30-1-deskka/mysql"
#define PLUGINDIR "/Applications/mampstack-5.5.30-1-deskka/mysql/lib/plugin"
#define DEFAULT_SYSCONFDIR "/Applications/mampstack-5.5.30-1-deskka/mysql/etc"
